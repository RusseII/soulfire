...
exports.formatRuneMetricsProfileSkills = (skillsArray) => {
    const skills = Object.assign({}, defaultSkillTree);
    runescape_1.hiscores.skills.map((skillName, index) => {
...
exports.parseJagexPlayerToJSON = (jagexPlayer) => {
...
exports.parseJagexClanToArray = (jagexClan) => {
...
exports.parseJagexOSRSPlayerToJSON = (jagexPlayer) => {
    const lines = separateIntoLines(jagexPlayer);
